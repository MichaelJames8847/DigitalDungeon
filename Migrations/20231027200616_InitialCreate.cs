    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "c3aaeb97-d2ba-4a53-a521-4eea61e59b35", "dc9dbc91-0036-4081-8dfc-7f69d5344c5a", "Admin", "admin" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "dbc40bc6-0829-4ac5-a3ed-180f5e916a5f", 0, "bdeba6cf-d0f0-4c8d-838f-243a67e8249e", "admina@strator.comx", false, false, null, null, null, "AQAAAAEAACcQAAAAEBvQHLSdVc0etanDnISSHTFTwXPeKPhk+t64XGcwHQX8wBLv7Tuj2MpHqKt4+sTVkg==", null, false, "ed584504-d46b-4e43-a583-f7e82cac604f", false, "Administrator" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 51, true, 2, "https://static.wikia.nocookie.net/starwars/images/d/d9/Kotoriibox.jpg/revision/latest?cb=20060603062220", "The sequel to Knights of the Old Republic, delving deeper into the Star Wars lore with a darker narrative and more refined gameplay mechanics.", "Obsidian Entertainment", 3, new DateTime(2004, 12, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "Star Wars: Knights of the Old Republic 2: The Sith Lords" },
                    ...
                    { 53, true, 2, "https://static.wikia.nocookie.net/starwars/images/8/82/Star_Wars_Jedi_Survivor_cover_art.jpg/revision/latest?cb=20221212004209", "A hypothetical Star Wars game where Jedi must survive against insurmountable odds.", "Hypothetical Studios", 1, new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Star Wars: Jedi Survivor" },
                    ...
                    { 62, true, 2, "https://static.wikia.nocookie.net/metalgear/images/3/3c/SLUS-00594-F-ALL.jpg/revision/latest?cb=20200303161503", "Sneak your way through a nuclear facility in Alaska with Solid Snake in this tactical espionage action game.", "Konami", 1, new DateTime(1998, 9, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Metal Gear Solid" },
                    ...
                    { 64, true, 1, "https://static.wikia.nocookie.net/castlevania/images/b/b0/Castlevania_-_Symphony_of_the_Night_%28gamebox%29.jpg/revision/latest/scale-to-width-down/1200?cb=20150822135929", "Explore Dracula's castle as Alucard, seeking to defeat the dark lord.", "Konami", 2, new DateTime(1997, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Castlevania: Symphony of the Night" },
                    ...
                    { 66, true, 5, "https://static.wikia.nocookie.net/capcomdatabase/images/f/fb/SFIICoverScan.png/revision/latest?cb=20080806031247", "Engage in fierce one-on-one battles with fighters from around the globe in this iconic fighting game.", "Capcom", 11, new DateTime(1991, 3, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Street Fighter II" },
                    ...
                    { 71, true, 2, "https://static.wikia.nocookie.net/metroid/images/b/ba/MetroidPrimebox.jpg/revision/latest?cb=20220716192249", "Explore the alien world of Tallon IV in first-person perspective as Samus Aran, battling space pirates and ancient creatures.", "Retro Studios", 1, new DateTime(2002, 11, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Metroid Prime" },
                    ...
                    { 75, true, 2, "https://static.wikia.nocookie.net/metroid/images/0/08/Super_Metroid_box.jpg/revision/latest?cb=20220628082152", "Guide Samus Aran on planet Zebes in her quest to rescue a baby Metroid from space pirates.", "Nintendo", 2, new DateTime(1994, 3, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "Super Metroid" },
                    ...
                    { 83, true, 15, "https://static.wikia.nocookie.net/spidermanps4/images/d/d4/Marvel%27s_Spider-Man_front_cover_%28US%29.png/revision/latest?cb=20201003182432", "An action-adventure game that lets players swing through New York City as the iconic superhero Spider-Man.", "Insomniac Games", 1, new DateTime(2018, 9, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), "Marvel's Spider-Man" },
                    ...
                    { 92, null, 1, "https://static.wikia.nocookie.net/dragonball/images/0/0f/GBA_DragonBallZ_BuusFury.jpg/revision/latest?cb=20080228180723", "Play through the final chapters of the Dragon Ball Z story, from the Other World Tournament saga to the Kid Buu saga.", null, 3, new DateTime(2004, 9, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Dragon Ball Z: Buu's Fury" },
                    ...
                    { 110, true, 5, "https://static.wikia.nocookie.net/streetsofrage/images/0/0a/SoRCover.jpg/revision/latest?cb=20190819175212", "Punch and kick your way through city streets to confront the evil Mr. X in this classic beat 'em up.", "Sega", 1, new DateTime(1992, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Streets of Rage 2" },
                    ...
                    { 126, true, 15, "https://static.wikia.nocookie.net/crackdown/images/c/c2/Crackdown-cover.png/revision/latest?cb=20100723015531", "An open-world action game where players assume the role of a super-powered agent tasked with taking down criminal syndicates in a futuristic city.", "Realtime Worlds", 1, new DateTime(2007, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Crackdown" },
                    ...
                    { 141, true, 7, "https://example.com/discoelysium_cover.jpg", "A detective role-playing game with a heavy focus on narrative and dialogue choices, set in a unique and gritty urban fantasy world.", "ZA/UM", 3, new DateTime(2019, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Disco Elysium" },
                    ...
                    { 147, true, 2, "https://static.wikia.nocookie.net/starwars/images/1/15/KotOR_Cover.png/revision/latest?cb=20131201215938", "A role-playing game set in the Star Wars universe, taking place thousands of years before the original films, allowing players to shape the fate of the galaxy.", "BioWare", 3, new DateTime(2003, 7, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Star Wars: Knights of the Old Republic" },
                    { 148, null, 1, "https://static.wikia.nocookie.net/dragonball/images/e/ed/Legacy_of_goku_2.jpg/revision/latest?cb=20100102065837", "Continue the DBZ saga, spanning from the Frieza saga to the end of the Cell Games.", null, 3, new DateTime(2003, 6, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "Dragon Ball Z: The Legacy of Goku II" },
                    { 149, null, 1, "https://static.wikia.nocookie.net/fable/images/8/8d/Fable_NTSC-U_Box_Art.jpg/revision/latest/scale-to-width-down/1200?cb=20230224035205", "In a fantasy world, grow from a young boy into a legendary hero. Every choice impacts your path, reputation, and the evolution of the world around you.", null, 19, new DateTime(2004, 9, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "Fable" },
